...
class SettingsDialog(ctk.CTkToplevel):
    ...
    def _build(self):
        ...
        self.rmin.set(self.config.get("rate_limit_min", 4)); self.rmin.pack(side="left", padx=5)
        ...
        self.rmax = ctk.CTkSlider(sf, from_=2, to=20, number_of_steps=18, width=120)
        self.rmax.set(self.config.get("rate_limit_max", 8)); self.rmax.pack(side="left", padx=5)
